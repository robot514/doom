#This function, when ran by a player, gives, said player, the full set of "Broken Relic" gear.
...
#This function uses replaceitem instead of give as the give command will drop the item for a split second.
#The behavior stated above is bad as it gives the main.mcfunction time to run the ondrop function which is no bueno.
