...
execute store result score G_z coord run data get entity @e[scores={target=1},limit=1] Pos[2]
#stores the z value of the target player in G_z



execute store result score G_y coord run data get entity @e[scores={target=1},limit=1] Pos[1]
#stores the y value of the target player in G_y


execute store result score G_x coord run data get entity @e[scores={target=1},limit=1] Pos[0]
