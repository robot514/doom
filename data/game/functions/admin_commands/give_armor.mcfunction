...
give @s compass{display:{Name:'{"text":"Target Tracker","color":"red","italic":false}',Lore:['{"text":"When Holding:","color":"blue","italic":false}','{"text":"Will display the last known","color":"gray","italic":false}','{"text":"location of the target","color":"gray","italic":false}','{"text":"above your hotbar","color":"gray","italic":false}']},targetTracker:1} 1
