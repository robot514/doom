...
tag @s[x=0,dx=-750,z=0,dz=750,y=0,dy=256] add quad_1
tag @s[x=0,dx=750,z=0,dz=750,y=0,dy=256] add quad_2
tag @s[x=0,dx=750,z=0,dz=-750,y=0,dy=256] add quad_3
tag @s[x=0,dx=-750,z=0,dz=-750,y=0,dy=256] add quad_4
